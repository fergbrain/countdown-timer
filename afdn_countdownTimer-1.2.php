				...
				<tr>
					...
					<?php 
						...
						for($i=0; $i < $oneTimeEvent_entriesCount+1; $i++){ 
							...
							<td><input type="text" size="25" name="oneTimeEvent_text<?php echo $oneTimeEvent_count; ?>" value="<?php echo $dates["oneTime"][$i]["text"]; ?>" /></td>
				...
				<tr>
					...
					<?php 
						...
						for($i=0; $i < $recurringEvent_entriesCount+1; $i++){ 
							...
							<td><input type="text" size="25" name="recurringEvent_text<?php echo $recurringEvent_count; ?>" value="<?php echo $dates["recurring"][$i]["text"]; ?>" /></td>
...
function afdn_countdownTimer(){
	...
	for($i = 0; $i < $eventCount; $i++){
		echo cdt_format($thisDate[$i]["text"], $thisDate[$i]["date"], (date("Z") - (get_settings('gmt_offset') * 3600)), $thisDate[$i]["timeSince"], $thisDate[$i]["link"], $getOptions["timeOffset"]);
	}
}
