...
# main config
PLUGINSLUG="countdown-timer"
CURRENTDIR=`pwd`
MAINFILE="fergcorp_countdownTimer.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/countdown-timer/" # Remote SVN repo on wordpress.org, with no trailing slash
...
NEWVERSION2=`grep "^Version" $GITPATH/$MAINFILE | awk -F' ' '{print $2}' | tr -d '\r'`
